export const ui = {
  ...
  results: {
    ...
    card: {
      ...
      rewrite: 'bg-white border border-gray-300 rounded-lg p-5',
      emphasis: 'bg-slate-50 border border-slate-200 rounded-lg p-5',
      muted: 'bg-gray-50 border border-gray-200 rounded-lg p-5',
    },
    section: {
      title: 'text-[20px] leading-snug font-semibold text-gray-900',
      subtitle: 'text-[15px] leading-relaxed text-gray-700',
      helper: 'text-[14px] text-gray-500',
    },
    text: {
      body: 'text-[16px] leading-relaxed text-gray-900',
      cardTitle: 'text-[16px] leading-relaxed font-medium text-gray-900',
      secondary: 'text-[15px] leading-relaxed text-gray-700',
      meta: 'text-[14px] leading-snug text-gray-500',
      metaStrong: 'text-[14px] leading-snug text-gray-700',
      label: 'text-[13px] leading-snug font-semibold text-gray-600',
    },
    ...
    chip: {
      ...
      impactHigh: 'bg-rose-50 text-rose-700 border-rose-200',
      impactMedium: 'bg-amber-50 text-amber-800 border-amber-200',
      impactLow: 'bg-slate-50 text-slate-700 border-slate-200',
      effortLow: 'bg-emerald-50 text-emerald-700 border-emerald-200',
      effortMedium: 'bg-stone-50 text-stone-700 border-stone-200',
      effortHigh: 'bg-orange-50 text-orange-700 border-orange-200',
    },
    list: {
